    ...
    <div id="pf-bd">
        <div id="pf-sider">
            ...
            <ul class="sider-nav">
                <!--<li class="current">-->
                <li>
                    <a href="javascript:addTab('纳税人管理','manage/taxpayer/listTaxPayer.jsp', 'taxpayer');">
                ...
                <li>
                    ...
                    <ul class="sider-nav-s">
                        <li class="active"><a href="javascript:void(0);" id="userInfo">个人基本信息</a></li>
                        <li><a href="javascript:void(0);" id="editPwd">密码修改</a></li>
