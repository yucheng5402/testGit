...
<html>
					...
					<div class="lg-box">
						...
						<form method="post">
							...
							<div class="lg-check clearfix">
								...
								<span class="check-code"><img id="captchaimg" src="kaptcha" style="cursor: pointer;" title="点击刷新"></span>
							</div>
							...
							<div class="enter">
								<a href="javascript:void(0);" id="supplier" class="supplier">登录</a>
  ...
  <script type="text/javascript">
  	...
  	var login = function(){
  		...
  		//发送ajax请求验证验证码
  		var validateImgCode = $.get("validateKaptcha", {"captcha":captcha}, function(result){
  			//返回成功
  			if (!result.success) {
  				$("#info").html("验证码错误");
  				updateKaptcha();
  		...
  		//验证码验证正确之后就进行登录操作
  	    $.when(validateImgCode).done(function(result){
  	    	//如果验证码正确，发送登录的ajax请求
  	    	if (result.success) {
